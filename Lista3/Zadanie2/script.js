...
var vertexShaderSrc= ""+
    ...
    "  vColorRGB = (vec3(0.3, 0.6, 0.8) + gl_Position.rgb) * 0.5; \n"+
    "} \n";
...
var fragmentShaderSrc2= ""+
    ...
    "void main(void) { \n"+
    "  gl_FragColor = vec4(uColorRGB, 0.9); \n"+
    "} \n";
